...
enum ScanPhase: String, CaseIterable, Equatable {
    case idle             = "Ready"
...
// MARK: - Scan State
// Plain struct — stored as @Published inside ScanEngine.
// Avoids @Observable / ObservableObject mixing which crashes on iOS 26.
...
struct ScanState {
    ...
    mutating func update(phase: ScanPhase,
                         processed: Int = 0,
                         total: Int = 0,
                         description: String = "") {
        self.phase = phase
